...
if ( !isset( $tdata['twp_api_token'] ) ) {
    $tdata['twp_api_token'] = new stdClass();
    $tdata['twp_api_token']->option_value = '';
}

if ( !isset( $tdata['twp_hashtag'] ) ) {
    $tdata['twp_hashtag'] = new stdClass();
    $tdata['twp_hashtag']->option_value = '';
}
if ( !isset( $tdata['twp_bot_token'] ) ) {
    $tdata['twp_bot_token'] = new stdClass();
    $tdata['twp_bot_token']->option_value = '';
}
if ( !isset( $tdata['twp_channel_username'] ) ) {
    $tdata['twp_channel_username'] = new stdClass();
    $tdata['twp_channel_username']->option_value = '';
}
if ( !isset( $tdata['twp_web_preview'] ) ) {
    $tdata['twp_web_preview'] = new stdClass();
    $tdata['twp_web_preview']->option_value = '';
}
if ( !isset( $tdata['twp_send_to_channel'] ) ) {
    $tdata['twp_send_to_channel'] = new stdClass();
    $tdata['twp_send_to_channel']->option_value = '';
}
if ( !isset( $tdata['twp_channel_pattern'] ) ) {
    $tdata['twp_channel_pattern'] = new stdClass();
    $tdata['twp_channel_pattern']->option_value = '';
}
if ( !isset( $tdata['twp_send_thumb'] ) ) {
    $tdata['twp_send_thumb'] = new stdClass();
    $tdata['twp_send_thumb']->option_value = '';
}
if ( !isset( $tdata['twp_markdown'] ) ) {
    $tdata['twp_markdown'] = new stdClass();
    $tdata['twp_markdown']->option_value = '';
}
