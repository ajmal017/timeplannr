...
function theme_name_scripts() {
	...
	*/
	...
	wp_enqueue_script( 'jquery-ui', '/content/themes/timeplannr/resources/assets/js/custom.js', array('jquery'), FALSE, TRUE);
	wp_enqueue_script( 'app-config', '/content/themes/timeplannr/resources/assets/test/js/app.config.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'jquery-ui-touch-punch', '/content/themes/timeplannr/resources/assets/test/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'bootstrap', '/content/themes/timeplannr/resources/assets/test/js/bootstrap/bootstrap.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'smart-notification', '/content/themes/timeplannr/resources/assets/test/js/notification/SmartNotification.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'jarvis-widget', '/content/themes/timeplannr/resources/assets/test/js/smartwidgets/jarvis.widget.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'easy-pie-chart', '/content/themes/timeplannr/resources/assets/test/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'sparkline', '/content/themes/timeplannr/resources/assets/test/js/plugin/sparkline/jquery.sparkline.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'jquery-validate', '/content/themes/timeplannr/resources/assets/test/js/plugin/jquery-validate/jquery.validate.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'maskedinput', '/content/themes/timeplannr/resources/assets/test/js/plugin/masked-input/jquery.maskedinput.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'select2', '/content/themes/timeplannr/resources/assets/test/js/plugin/select2/select2.min.js', array(), FALSE, TRUE);
	...
	wp_enqueue_script( 'mb-browser', '/content/themes/timeplannr/resources/assets/test/js/plugin/msie-fix/jquery.mb.browser.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'fastclick', '/content/themes/timeplannr/resources/assets/test/js/plugin/fastclick/fastclick.min.js', array(), FALSE, TRUE);
	// wp_enqueue_script( 'demo', '/content/themes/timeplannr/resources/assets/test/js/demo.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'app', '/content/themes/timeplannr/resources/assets/test/js/app.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'voicecommand', '/content/themes/timeplannr/resources/assets/test/js/speech/voicecommand.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'smart-chat-ui', '/content/themes/timeplannr/resources/assets/test/js/smart-chat-ui/smart.chat.ui.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'smart-chat-manager', '/content/themes/timeplannr/resources/assets/test/js/smart-chat-ui/smart.chat.manager.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'flot-cust', '/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.cust.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'flot-resize', '/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.resize.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'flot-time', '/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.time.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'flot-tooltip', '/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.tooltip.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'jvectormap', '/content/themes/timeplannr/resources/assets/test/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'jvectormap-world-mill', '/content/themes/timeplannr/resources/assets/test/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'moment', '/content/themes/timeplannr/resources/assets/test/js/plugin/moment/moment.min.js', array(), FALSE , TRUE);
