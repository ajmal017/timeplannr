...
function theme_name_scripts() {
	...
	*/
	...
	wp_enqueue_script( 'jquery-ui', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/js/custom.js', array('jquery'), FALSE, TRUE);
	wp_enqueue_script( 'app-config', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/app.config.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'jquery-ui-touch-punch', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'bootstrap', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/bootstrap/bootstrap.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'smart-notification', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/notification/SmartNotification.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'jarvis-widget', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/smartwidgets/jarvis.widget.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'easy-pie-chart', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'sparkline', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/sparkline/jquery.sparkline.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'jquery-validate', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/jquery-validate/jquery.validate.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'maskedinput', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/masked-input/jquery.maskedinput.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'select2', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/select2/select2.min.js', array(), FALSE, TRUE);
	// wp_enqueue_script( 'bootstrap-slider', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/bootstrap-slider/bootstrap-slider.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'mb-browser', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/msie-fix/jquery.mb.browser.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'fastclick', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/fastclick/fastclick.min.js', array(), FALSE, TRUE);
	// wp_enqueue_script( 'demo', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/demo.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'app', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/app.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'voicecommand', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/speech/voicecommand.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'smart-chat-ui', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/smart-chat-ui/smart.chat.ui.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'smart-chat-manager', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/smart-chat-ui/smart.chat.manager.min.js', array(), FALSE, TRUE);
	wp_enqueue_script( 'flot-cust', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.cust.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'flot-resize', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.resize.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'flot-time', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.time.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'flot-tooltip', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/flot/jquery.flot.tooltip.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'jvectormap', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'jvectormap-world-mill', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js', array('jquery'), FALSE , TRUE);
	wp_enqueue_script( 'moment', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/moment/moment.min.js', array(), FALSE , TRUE);
	// wp_enqueue_script( 'fullcalendar', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/fullcalendar/jquery.fullcalendar.min.js', array('jquery'), FALSE , TRUE);

	// wp_enqueue_script( 'npm', get_template_directory_uri() . '/resources/assets/js/bootstrap/dist/js/npm.js' );
	// wp_enqueue_script( 'pace', 'http://timeplannr.amber/content/themes/timeplannr/resources/assets/test/js/plugin/pace/pace.min.js');
